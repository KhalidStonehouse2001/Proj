...
function Checkout() {
  ...
  const monthlyCost = basketTotal / 12;
  ...
  const createCheckoutSession = async () => {
    ...
    if ((checkoutSession as any).statuscCode === 500) {
            ...
            <div className="max-w-3xl my-12 mt-6 ml-auto">
              ...
              <div className="space-y-4 my-14">
                ...
                <div className="flex flex-col gap-4 md:flex-row">
                  <div className="flex flex-col items-center flex-1 order-1 p-8 py-12 text-center bg-gray-200 rounded-xl">
                    <h4 className="flex flex-col mb-4 text-xl font-semibold">
                      <span>Pay Monthly</span>
                      <span>with Apple Card</span>
                      <span>
                        £{monthlyCost.toFixed(2)}/mo. at 0% APR
